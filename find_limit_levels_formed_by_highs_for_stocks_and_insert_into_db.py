...
def count_how_many_highs_higher_than_level_formed_by_highs_asset_had(engine_for_ohlcv_data_for_stocks,
                                      table_name_with_ohlcv_data, level_formed_by_high):
    ...
    how_many_highs_higher_than_level_formed_by_highs_asset_had =\
        np.count_nonzero ( table_with_ohlcv_data_df["high"] > level_formed_by_high )

    return how_many_highs_higher_than_level_formed_by_highs_asset_had


def find_limit_levels_formed_by_highs_for_stocks(so_many_number_of_touches_of_level_by_highs,
        ...
        try:
            ...
            for level in dict_of_highs_with_timestamps.keys ():
                ...
                if len ( dict_of_highs_with_timestamps ) > 0:
                    ...
                    how_many_highs_higher_than_level_formed_by_highs_asset_had = \
                        count_how_many_highs_higher_than_level_formed_by_highs_asset_had ( engine_for_stocks_ohlcv ,
                                                                                        stock_ticker ,
                                                                                        level )
                    ...
                    if how_many_highs_higher_than_level_formed_by_highs_asset_had in range ( 0 , 6 ):
                        last_row_of_levels_formed_by_highs_df = levels_formed_by_highs_df.iloc[-1:]
                        table_where_levels_formed_by_highs_will_be_for_false_breakout_calculation = \
                            f"levels_with_{how_many_highs_higher_than_level_formed_by_highs_asset_had}_number_of_highs_higher_than_level_formed_by_highs"
                        last_row_of_levels_formed_by_highs_df.to_sql ( table_where_levels_formed_by_highs_will_be_for_false_breakout_calculation ,
                                                                      connection_to_levels_formed_by_highs_and_lows_in_stocks ,
                                                                      if_exists = 'append' ,
                                                                      index = False )
