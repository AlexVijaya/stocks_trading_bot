...
def find_levels_formed_by_highs_and_lows(db_with_daily_ohlcv_stock_data,
...
if __name__=="__main__":
    so_many_last_days_for_level_calculation = 252*4
    ...
    find_levels_formed_by_highs_and_lows(db_with_daily_ohlcv_stock_data,
                                         db_where_levels_formed_by_high_or_low_will_be,
                                         table_where_levels_formed_by_highs_will_be,
                                         table_where_levels_formed_by_lows_will_be,
                                         so_many_last_days_for_level_calculation)
