...
def plot_ohlcv_chart_with_levels_formed_by_highs (name_of_folder_where_plots_will_be,
    ...
    engine_for_levels_formed_by_high_db , connection_to_levels_formed_by_high = \
        connect_to_postres_db ( db_where_levels_formed_by_highs_are_stored )
...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'round_levels_formed_by_highs_which_had_certain_numbers_of_false_breakouts'
