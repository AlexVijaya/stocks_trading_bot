...
import plot_mirror_levels_equal_to_last_high_or_low_for_stocks
...
def main_plot_mirror_levels_if_they_were_equal_to_last_high_or_low():
    ...
    plot_mirror_levels_equal_to_last_high_or_low_for_stocks.plot_ohlcv_chart_with_mirror_levels_from_given_exchange ( name_of_folder_where_plots_will_be ,
