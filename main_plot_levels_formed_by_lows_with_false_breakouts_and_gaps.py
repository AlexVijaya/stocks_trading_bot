...
import find_limit_levels_formed_by_lows_for_stocks_and_insert_into_db
...
import check_if_asset_is_approaching_its_atl
import plot_stock_charts_with_levels_formed_by_atl
...
def main_plot_levels_formed_by_lows_with_false_breakouts_and_gaps():
    ...
    # find_limit_levels_formed_by_lows_for_stocks_and_insert_into_db.\
    ...
    percentage_between_atl_and_closing_price = 5
    check_if_asset_is_approaching_its_atl.check_if_asset_is_approaching_its_atl ( percentage_between_atl_and_closing_price ,
                                            db_where_ohlcv_data_for_stocks_is_stored ,
    ...
    try:
        plot_stock_charts_with_levels_formed_by_atl.plot_ohlcv_chart_with_levels_formed_by_atl ( name_of_folder_where_plots_will_be ,
                                                      db_where_ohlcv_data_for_stocks_is_stored ,
