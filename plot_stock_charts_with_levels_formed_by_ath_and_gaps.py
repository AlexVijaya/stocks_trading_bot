...
def add_gap_up_levels(fig,table_with_gaps_up_df_for_one_stock,min_low):
    # add gap up levels
    try:
        if len ( table_with_gaps_up_df_for_one_stock ) != 0:
            ...
            for row_number_in_table_with_gaps_up in range ( 0 ,
                ...
                if gap_level_upper_border>=min_low:
                    fig.add_hline ( y = gap_level_upper_border ,
                                    line_dash = 'dash' ,
                ...
                if gap_level_lower_border>=min_low:
                    fig.add_hline ( y = gap_level_lower_border ,
                                    line_dash = 'dash' ,
                                    line_color = line_color , row = 2 , col = 1 ,
                                    # annotation_text = f"{broken_or_not_broken_bool}" ,
...
def add_gap_down_levels(fig,table_with_gaps_down_df_for_one_stock,min_low):
    # add gap down levels
    try:
    ...
    for row_with_level_formed_by_ath in range ( 0 , len ( table_of_levels_formed_by_ath_df ) ):
        ...
        try:
            ...
            try:
                ...
                min_low = data_df['low'].tail ( plot_this_many_last_days_in_second_plot ).min ()
                print ( "min_low" )
                print ( min_low )

                add_gap_up_levels ( fig , table_with_gaps_up_df_for_one_stock , min_low )
                add_gap_down_levels ( fig , table_with_gaps_down_df_for_one_stock , min_low )
                ...
                #                 fig.add_hline ( y = gap_level_upper_border ,
                #                                 line_dash = 'dash' ,
                #                                 line_color = 'green' , row = subplot_number, col = 1 ,
                #                                 annotation_text = f"{broken_or_not_broken_bool}" ,
                #                                 annotation_position = "top left" ,
                ...
                #                 fig.add_hline ( y = gap_level_lower_border ,
                #                                 line_dash = 'dash' ,
                #                                 line_color = 'red' , row = subplot_number , col = 1 ,
                #                                 annotation_text = f"{broken_or_not_broken_bool}" ,
                #                                 annotation_position = "bottom left" ,
                #                                 annotation_font_size = 5 )
                # except:
...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'levels_formed_by_ath_and_gaps'
