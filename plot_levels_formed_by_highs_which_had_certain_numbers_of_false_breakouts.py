...
def plot_ohlcv_chart_with_levels_formed_by_highs (name_of_folder_where_plots_will_be,
    ...
    engine_for_levels_formed_by_high_db , connection_to_levels_formed_by_high = \
        connect_to_postres_db_without_deleting_it_first ( db_where_levels_formed_by_highs_are_stored )

    table_with_all_high_levels_df = pd.read_sql ( f'''select * from {table_where_levels_formed_by_highs_are_stored} ;''' ,
                                                  connection_to_levels_formed_by_high )
    ...
    for row_of_highs in range(0,len(table_with_all_high_levels_df)):
        ...
        try:
            ...
            stock_ticker = table_with_all_high_levels_df.loc[row_of_highs , 'ticker']
            ...
            print ( f'{stock_ticker} on {exchange} is number {row_of_highs + 1} '
            ...
            try:
                ...
                #                                           f"on {exchange} with level formed by_high={level_formed_by_high}" )
                fig.print_grid ()
    ...
    connection_to_levels_formed_by_high.close()
    connection_to_stock_tickers_ohlcv.close()
    end_time = time.time ()
...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'levels_formed_by_highs_which_had_certain_numbers_of_false_breakouts'
    db_where_levels_formed_by_highs_are_stored = "levels_formed_by_highs_and_lows_for_stocks"
    table_where_levels_formed_by_highs_are_stored = "levels_formed_by_highs"
